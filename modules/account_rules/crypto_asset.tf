resource tokend_account_rule "crypto_sender" {
  action     = "send"
  entry_type = "asset"
...
resource tokend_account_rule "crypto_payment_receiver" {
...
resource tokend_account_rule "crypto_atomic_swap_receiver" {
...
output "crypto_sender" {
  value = "${tokend_account_rule.crypto_sender.id}"
}

output "crypto_atomic_swap_receiver" {
  value = "${tokend_account_rule.crypto_atomic_swap_receiver.id}"
}

output "crypto_payment_receiver" {
  value = "${tokend_account_rule.crypto_payment_receiver.id}"
}
